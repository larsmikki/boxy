  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <div style={sectionStyle}>
        ...
        <p className="text-xs mb-5" style={{ color: theme.text2 }}>Boxy is and always will be free, open source, and self-hosted.</p>
      ...
      <div style={{ ...sectionStyle, marginBottom: 0 }}>
        ...
        <p className="text-xs" style={{ color: theme.text2 }}>
          Every bit of support keeps Boxy free for everyone. Happy collecting! 🎮
        </p>
      </div>
    </div>
  )

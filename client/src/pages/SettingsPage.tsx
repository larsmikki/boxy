...
export default function SettingsPage() {
  ...
  const handleExport = async () => {
    ...
    try {
      ...
      a.href = url
      a.download = `collectr-backup-${new Date().toISOString().split('T')[0]}.json`
      a.click()
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-sm mt-0.5 text-text2">Customize your Collectr experience.</p>
      </div>

      <Surface className="p-6 mb-5">
        <h2 className="text-base font-bold mb-1 text-text">Themes</h2>
        <p className="text-xs mb-5 text-text2">Choose how Collectr looks to you.</p>
        <ThemePicker />
      </Surface>
